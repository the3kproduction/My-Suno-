...
const { OpenAI } = require("openai"); // ← choose the correct one based on your package version
const fs = require("fs");
...
app.post("/post", async (req, res) => {
    ...
    if (useAI && process.env.OPENAI_API_KEY) {
        const prompt = `Write a catchy song description and hashtags for a ${genre} track titled "${title}".`;
